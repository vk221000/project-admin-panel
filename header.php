                ...
                foreach ($_SESSION['cart'] as $key=>$val) {
                  ...
                  $html.='<ul>
                    <li>
                      ...
                      <a class="aa-remove-product" href="deletecart.php?deleteid='.$val["id"].'"><span class="fa fa-times"></span></a>
                    </li>'; 
                  ...
                  echo $html;
                  ?>
                  <a class="aa-cartbox-checkout aa-primary-btn" href="addorders.php?checkout=1">Checkout</a>
                </div>
              </div>
              <!-- / cart box -->
              <!-- search box -->
