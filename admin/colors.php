			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">colors</a></li> <!-- href must be unique and match the id of target div -->
					...
					<div class="tab-content" id="tab2">
						...
						<form action="addcolors.php" method="POST">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                ...
                                <p>
									<label>Color</label>
										<input class="text-input small-input" type="text"  name="colors" /> <!-- Classes for input-notification: success, error, information, attention -->
								</p>
                                <p>
									<label>Quantity</label>
										<input class="text-input small-input" type="text"  name="quantity" /> <!-- Classes for input-notification: success, error, information, attention -->
								</p>
