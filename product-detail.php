<?php include 'header.php'; ?>
  ...
  if (isset($_GET["id"])) {
    ...
    $html='<section id="aa-product-details">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="images/football.png" class="simpleLens-lens-image"><img src="img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">$'.$price.'.00</span>
                      <p class="aa-product-avilability">Avilability: <span>In stock</span></p>
                    </div>
                    <p>'.$short_description.'.'.$long_description.'</p>
                    <p> '.$category.' | '.$color.' | '.$tags.'<p>
                    <h4>Size</h4>
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="cart.php?id='.$id.'">Add To Cart</a>
                    </div>
                  </div>
                </div>
              </div>
